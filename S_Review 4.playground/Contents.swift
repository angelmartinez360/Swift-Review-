...
var name: String = "Amandla Stenberg"
/*:
...
var results = (Double (c)) * (Double(b)) + d / f
var x = b - c * a
print(results)
/*:
- Add two constants
...
var array: [String] = ["shirt", "pants", "shoes", "socks", "underwear"]
var tuple = ("Yes", "No")
for item in array {
    print(item)
...
func multiDoub(num1: Double, num2: Double) -> Double {
    return num1 * num2
}
var answer = multiDoub(num1:e, num2:f)
/*:
- Closures
...
var fullName = yourName(first: Junellie, second: Rhea, last: Martinez)
fullName.first
fullName.second
fullName.last
